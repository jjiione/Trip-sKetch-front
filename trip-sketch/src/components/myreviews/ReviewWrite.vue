...
.wrapper {
	background-image: url("@/assets/day/Road/john-towner-3Kv48NS4WUU-unsplash.jpg");
	min-height: 100vh;
...
@font-face {
	...
	src: url("../user/fonts/Material-Design-Iconic-Font.woff2?v=2.2.0") format("woff2"),
		url("../user/fonts/Material-Design-Iconic-Font.woff?v=2.2.0") format("woff"),
		url("../user/fonts/Material-Design-Iconic-Font.ttf?v=2.2.0") format("truetype");
	font-weight: normal;
	font-style: normal;
}
