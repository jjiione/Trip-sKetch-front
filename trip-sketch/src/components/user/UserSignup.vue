			...
			<form action="" @submit.prevent="onSubmit">
				...
				<div class="form-wrapper">
					<input
						...
						class="form-control"
					/>
					<i class="zmdi zmdi-check" style="font-size: 17px"></i>
				</div>
	...
	methods: {
		...
		checkValue() {
			...
			err &&
				...
				((msg = "비밀번호가 일치하지 않습니다."), (err = false), this.$refs.newPwd.focus());
			err &&
			...
			if (newpwd == document.querySelector("#userPwd").value) {
			...
			} else (msg = "비밀번호가 일치하지 않습니다."), (err = false), this.$refs.newPwd.focus();
